                ...
                for event_dict in event_dicts:
                    ...
                    if (start_date is not None) and (end_date is not None):
                        if start_date == end_date:
                            event_details = f"{start_date.strftime('%b %d, %Y')}\n"
                        elif start_date.month == end_date.month:
                            event_details = f"{start_date.strftime('%b %d')}-{end_date.strftime('%d, %Y')}\n"
                        else:
                            event_details = f"{start_date.strftime('%b %d')} - {end_date.strftime('%b %d, %Y')}\n"
                    else:

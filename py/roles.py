            ...
            try:
                ...
                if discord_member is not None:
                    ...
                    if role_god is not None and role_pleb is not None:
                        ...
                        log.logger_discord.warning("Role not found. Can not promote role for user " + str(discord_id))
                else:
            ...
            try:
                ...
                if discord_member is not None:
                    ...
                    if role_god is not None and role_pleb is not None:
                        ...
                        log.logger_discord.warning("Role not found. Can not demote role for user " + str(discord_id))
                else:
                    log.logger_discord.warning("User: " + str(discord_id) + " not found. Can not demote role.")
            except NotFound:
                log.logger_discord.warning("User: " + str(discord_id) + " not found. Can not demote role.")

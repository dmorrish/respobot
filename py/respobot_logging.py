...
handler.setFormatter(logging.Formatter("{'args': null, 'created': %(created)f, 'exc_text': '', 'filename': '%(filename)s', 'funcName': '%(funcName)s', 'levelname': '%(levelname)s', 'levelno': %(levelno)d, 'lineno': %(lineno)d, 'module': '%(module)s', 'msecs': %(msecs)d, 'msg': '%(message)s', 'name': '%(name)s', 'pathname': '', 'process': %(process)d, 'processName': '%(processName)s', 'relativeCreated': %(relativeCreated)d, 'stack_info': '%(stack_info)s', 'thread': %(thread)d, 'threadName': '%(threadName)s'},"))
...
handler2.setFormatter(logging.Formatter("{'args': null, 'created': %(created)f, 'exc_text': '', 'filename': '%(filename)s', 'funcName': '%(funcName)s', 'levelname': '%(levelname)s', 'levelno': %(levelno)d, 'lineno': %(lineno)d, 'module': '%(module)s', 'msecs': %(msecs)d, 'msg': '%(message)s', 'name': '%(name)s', 'pathname': '', 'process': %(process)d, 'processName': '%(processName)s', 'relativeCreated': %(relativeCreated)d, 'stack_info': '%(stack_info)s', 'thread': %(thread)d, 'threadName': '%(threadName)s'},"))
...
handler3.setFormatter(logging.Formatter("{'args': null, 'created': %(created)f, 'exc_text': '', 'filename': '%(filename)s', 'funcName': '%(funcName)s', 'levelname': '%(levelname)s', 'levelno': %(levelno)d, 'lineno': %(lineno)d, 'module': '%(module)s', 'msecs': %(msecs)d, 'msg': '%(message)s', 'name': '%(name)s', 'pathname': '', 'process': %(process)d, 'processName': '%(processName)s', 'relativeCreated': %(relativeCreated)d, 'stack_info': '%(stack_info)s', 'thread': %(thread)d, 'threadName': '%(threadName)s'},"))
...
handler4.setFormatter(logging.Formatter("{'args': null, 'created': %(created)f, 'exc_text': '', 'filename': '%(filename)s', 'funcName': '%(funcName)s', 'levelname': '%(levelname)s', 'levelno': %(levelno)d, 'lineno': %(lineno)d, 'module': '%(module)s', 'msecs': %(msecs)d, 'msg': '%(message)s', 'name': '%(name)s', 'pathname': '', 'process': %(process)d, 'processName': '%(processName)s', 'relativeCreated': %(relativeCreated)d, 'stack_info': '%(stack_info)s', 'thread': %(thread)d, 'threadName': '%(threadName)s'},"))
